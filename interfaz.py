...
def imprimir_interfaz(pantalla, vida, contador_ssj, esta_ssj, gd_bool, gd_counter = None):
    # Barra vida
    corazon = pygame.image.load('Dragon_Ball\\resources\HUD\pixel_art_corazon.png')
    ...
    if gd_bool:
        ...
        drect(pantalla, 'grey', rect, 0, 12)
        rect = pygame.Rect(SCREEN_WIDTH - 312, altura*4, 12.5 * gd_counter, 18)
